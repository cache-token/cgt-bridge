...
interface FxCacheRootTunnelInterface extends ethers.utils.Interface {
  functions: {
    "DEPOSIT()": FunctionFragment;
    "MAP_TOKEN()": FunctionFragment;
    "SEND_MESSAGE_EVENT_SIG()": FunctionFragment;
    "checkpointManager()": FunctionFragment;
    "deposit(address,address,address,uint256,bytes)": FunctionFragment;
...
export class FxCacheRootTunnel extends BaseContract {
  ...
  interface: FxCacheRootTunnelInterface;
