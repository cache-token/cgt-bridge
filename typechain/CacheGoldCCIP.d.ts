...
interface CacheGoldCCIPInterface extends ethers.utils.Interface {
  functions: {
    "CCIP_MANAGER_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "CCIP_MANAGER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CacheGoldCCIP extends BaseContract {
  ...
  interface: CacheGoldCCIPInterface;

  functions: {
    CCIP_MANAGER_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    CCIP_MANAGER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    CCIP_MANAGER_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
